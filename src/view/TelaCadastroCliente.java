...
public class TelaCadastroCliente extends JFrame {
	...
	private void salvarCliente() {
		try {
			...
			String cpf = txtCpf.getText().replaceAll("[^0-9]", ""); // remove tudo que não for número
			String telefone = txtTelefone.getText().replaceAll("[^0-9]", ""); // remove letras
			...
			if (telefone.isEmpty() || telefone.length() < 10) {
				JOptionPane.showMessageDialog(this, "Telefone inválido! Informe um número válido.");
			...
			boolean cadastrado = controller.cadastrarCliente(nome, cpf, telefone, email);
